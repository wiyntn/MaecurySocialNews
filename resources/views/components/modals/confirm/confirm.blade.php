<div x-data="{ isSubmitting: false }" x-cloak>
    <template x-if="$store.confirmModal && $store.confirmModal.isOpen">
        <div>
            <x-modals.modal>
                    ...
                    <div class="border-t border-bord-pr">
                        <div class="grid grid-cols-2">
                            <div class="flex py-4 justify-center border-r border-bord-pr hover:bg-fill-fv">
                                <button x-bind:disabled="isSubmitting" 
                                        x-on:click="$store.confirmModal.close()" 
                                        type="button" 
                                        class="text-par-s text-brand-900 outline-hidden leading-none disabled:opacity-80 cursor-pointer" 
                            ...
                            <div class="flex py-4 justify-center hover:bg-fill-fv">
                                <button x-bind:disabled="isSubmitting" 
                                        type="submit" 
                                        class="text-par-s cursor-pointer text-red-900 outline-hidden leading-none disabled:opacity-80" 
